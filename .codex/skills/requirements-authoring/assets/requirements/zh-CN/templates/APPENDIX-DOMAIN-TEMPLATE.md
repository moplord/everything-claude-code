...
| 字段(中文) | FieldCode(camelCase) | 业务含义 | 类型候选(JDL) | 必填 | 默认值 | 长度/精度/Scale | 校验/范围 | 唯一/索引 | 系统维护 | 说明 | 示例 |
|---|---|---|---|---:|---|---|---|---|---:|---|---|
...
| 关系名 | A 实体(EntityCode) | B 实体(EntityCode) | 基数 | 拥有方 | 必填 | 是否双向 | Join/字段(FieldCode) | 删除/级联 | 备注 |
|---|---|---|---|---|---:|---:|---|---|---|
